...
export default function Home({ data }: PageProps<Data>) {
  ...
  return (
    <div class="h-screen p-10 flex flex-col bg-gradient-to-b from-yellow-200 via-green-200 to-green-300">
      <div class="flex-auto h-full">
        <div class="text-center">
          <h2 class="text-lg font-bold">
            welcome to the robo ape zone
          </h2>
          <h6 class="text-md font-light italic">
        ...
        <div class="p-10 mt-3 w-100 text-left">
          <form>
            <div class="flex flex-row">
              <div class="flex flex-col">
                ...
                <input type="text" name="msg" value={msg} class="p-2 rounded border mr-3" />
                <p class="my-2 italic">
                  set your chances (for rolls)
                </p>
                <select name="account" value={acctId} class="p-2 bg-blue-800 rounded text-white">
                ...
                <button type="submit" class="p-2 my-4 h-12 bg-indigo-300 rounded">see what ape say</button>
              </div>
            </div>
          </form>
        </div>

        {msg !== "" && <div class="p-10 mt-3 w-100 text-righ flex flex-col items-end">
      ...
      <footer class="text-center text-purple-800 underline ">
